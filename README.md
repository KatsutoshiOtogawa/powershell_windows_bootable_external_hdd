...
# powershell create windows bootable external hdd

## ref

[zenn](https://zenn.dev/cumet04/articles/windows-on-external-disk)
[pwsh](https://tech.guitarrapc.com/entry/2016/05/28/173049)
[pwshコマンドレットとdismの対応](https://docs.microsoft.com/ja-jp/windows-hardware/manufacture/desktop/use-dism-in-windows-powershell-s14?view=windows-11)
